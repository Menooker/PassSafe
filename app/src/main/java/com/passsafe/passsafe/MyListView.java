...
public class MyListView extends ListView {
    ...
    static public interface DeleteClickListener {
    ...
    public MyListView(Context context, @Nullable AttributeSet attrs) {
        ...
        View view = mInflater.inflate(R.layout.layout_delete, null);   //找到删除按钮的view
        delete = (TextView) view.findViewById(R.id.txt_delete);     //找到删除按钮的控件
